...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl">
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea name="text" id="text" required rows="4"
                      ...
                      placeholder="Write the quote given by the client here...">{{ old('text') }}</textarea>
        </div>
