...
@section('page-title', 'Modify Team Member')
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl">
    <form action="{{ route('admin.team.update', $team) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="role" id="role" required value="{{ old('role', $team->role) }}"
                       class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $team->sort_order) }}"
                       class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
                       placeholder="e.g. 0">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
                      placeholder="Write a brief professional bio for this team member...">{{ old('description', $team->description) }}</textarea>
        </div>
        ...
        <div>
            ...
            <textarea name="qualifications" id="qualifications" rows="4"
                      class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
                      placeholder="e.g.&#10;Founder & Proprietor- Pushpraj Construction&#10;Bachelor of Science (B.Sc.)&#10;17+ Years- Infrastructure & Construction Industry">{{ old('qualifications', $team->qualifications) }}</textarea>
        ...
        <!-- Team Member Avatar -->
        <div x-data="{ preview: '{{ $team->image ? asset($team->image) : '' }}' }">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="linkedin" id="linkedin" value="{{ old('linkedin', $team->linkedin) }}"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="facebook" id="facebook" value="{{ old('facebook', $team->facebook) }}"
                               class="block w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all text-sm"
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="twitter" id="twitter" value="{{ old('twitter', $team->twitter) }}"
                               class="block w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all text-sm"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="instagram" id="instagram" value="{{ old('instagram', $team->instagram) }}"
                               class="block w-full pl-10 pr-4 py-2.5 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all text-sm"
