...
@section('title', 'Add New Milestone')
...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl">
    <form action="{{ route('admin.milestones.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
        @csrf
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="year" id="year" required value="{{ old('year') }}"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      ...
                      placeholder="Provide specific details about this landmark company achievement...">{{ old('description') }}</textarea>
        </div>
