...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl">
    <form action="{{ route('admin.careers.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
        @csrf
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input type="text" name="location" id="location" required value="{{ old('location', 'Botad, Gujarat') }}"
                       class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
            ...
            <div>
                ...
                <input type="text" name="experience_required" id="experience_required" required value="{{ old('experience_required') }}"
                       class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="5" required
                      ...
                      placeholder="Explain the roles and responsibilities associated with this civil construction opening...">{{ old('description') }}</textarea>
        </div>
