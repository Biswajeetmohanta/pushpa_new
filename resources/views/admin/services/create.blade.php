...
<div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden max-w-4xl">
    <form action="{{ route('admin.services.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
        @csrf
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="icon" id="icon" value="{{ old('icon', 'briefcase') }}"
                       class="block w-full px-4 py-3 rounded-lg border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all"
        ...
        <div>
            ...
            <textarea name="description" id="description" rows="4"
                      ...
                      placeholder="Explain the scope and nature of this civil construction service...">{{ old('description') }}</textarea>
        </div>
