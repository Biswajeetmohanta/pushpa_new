...
@section('title', 'Company Milestones | Pushpraj Construction')
@section('meta_description', 'Discover the key achievements, growth timeline, and completed works that define Pushpraj Construction from 2005 to today.')
...
<div class="relative bg-[#0f2a4a] text-white py-16 sm:py-24 overflow-hidden" 
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
        <nav class="flex justify-center gap-2 text-xs sm:text-sm uppercase tracking-wider font-semibold text-accent mb-4">
            ...
            <span>/</span>
            <span class="text-white/60">Milestones</span>
        </nav>
        ...
        <p class="text-white/70 text-xs sm:text-sm mt-3 max-w-2xl mx-auto font-sans">
            Tracking years of steady growth, infrastructure scale, and landmark accomplishments in our history.
        </p>
    </div>
</div>
